...
var $author$project$Components$Players$Player = F9(
...
var $author$project$Components$Players$playerDecoder = A3(
						...
						A3(
							...
							A3(
								...
								A3(
									...
									'DATESTAMP',
									$elm$json$Json$Decode$int,
									$elm$json$Json$Decode$succeed($author$project$Components$Players$Player))))))))));
var $author$project$Components$Players$ladderOfPlayersDecoder = function () {
...
var $author$project$Pages$Rankings$Top$expectJson = F2(
	function (toMsg, decoder) {
		return A2(
			$elm$http$Http$expectStringResponse,
			toMsg,
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$map,
						function (prop) {
							return prop + (' ' + ($elm$core$String$fromInt(duration) + 'color 200ms ease-in-out'));
						},
						properties))));
	});
...
var $author$project$Pages$Guide$view = $author$project$Ui$hero(
	{
		buttons: _List_fromArray(
			[
				_Utils_Tuple2('back to home', '/')
			]),
		...
		_List_fromArray(
			[
				...
				A2(
					$author$project$Layout$viewLink,
					currentRoute,
					_Utils_Tuple2('', $author$project$Generated$Routes$routes.docs_top))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				A2(
					$author$project$Layout$viewLink,
					currentRoute,
					_Utils_Tuple2('', $author$project$Generated$Routes$routes.guide)))
			]));
};
